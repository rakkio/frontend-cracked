...
import { FaFire, FaDesktop, FaAndroid, FaApple, FaGamepad, FaDownload, FaStar, FaEye, FaArrowRight } from 'react-icons/fa'
...
export default function TrendingPageClient({ initialData }) {
                    ...
                    <div className="flex items-center justify-between mb-8">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600 text-sm">{items.length} items trending</p>
                            </div>
                        </div>
                        <Link 
                            href={`/${type}`}
                            ...
                            <SwiperSlide key={`${item.type}-${item._id || item.id}`}>
                                <Link href={`/${getCategorySlug(item)}/${item.slug}`} className="block">
                                    ...
                                    >
                                        ...
                                        {/* Item Info */}
                                        <div className="p-4">
                                            <h3 className="font-bold text-gray-800 text-sm mb-2 line-clamp-2 group-hover:text-red-500 transition-colors duration-300">
                                                {item.name}
                                            </h3>
            ...
            <section className="py-20 bg-gradient-to-br from-red-50 to-pink-50">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <p className="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
                        Discover thousands of applications across all platforms. From productivity tools to entertainment apps.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        <Link
                            href="/apps"
                            className="bg-red-500 hover:bg-red-600 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg"
                        >
                            Browse All Apps
                        </Link>
                        <Link
